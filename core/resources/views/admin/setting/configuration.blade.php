                ...
                <form action="" method="post">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">
                                        ...
                                        <small>@lang('You need to configure a third party API from')
                                            <a href="{{ route('admin.api.config.reloadly') }}">@lang('here')</a>
                                        </small>
                                    </p>
                                </div>
                                <div class="form-group">
                            ...
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Detect User Activity')</p>
                                    <p class="mb-0">
                                        <small>@lang('If user is idle for a certain period of time, he/she will be logged out from the system.')</small>
                                        <small>@lang('You can change time from') <a href="{{ route('admin.setting.index') }}">@lang('here')</a></small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input name="detect_activity" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if ($general->detect_activity) checked @endif>
                                </div>
                            </li>
                        </ul>
                    </div>
