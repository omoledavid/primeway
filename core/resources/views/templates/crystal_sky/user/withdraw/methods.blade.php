        ...
        <div class="col-lg-6">
            <div class="card custom--card">
                <div class="card-body">
                    ...
                    <h6 class="text-center">@lang('Current Balance'): {{ showAmount(auth()->user()->balance) }} {{ __($general->cur_text) }}</h6>
                    ...
                    <form action="{{ route('user.withdraw.apply') }}" method="post">
                        ...
                        <div class="mt-3">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-none justify-content-between px-0 rate-element"></li>

                                <li class="list-group-item d-none justify-content-between px-0 in-site-cur">
    ...
    <script>
        (function($) {
            ...
            $('select[name=method_code]').on('change', function() {
                ...
                let final_amount = parseFloat(parseFloat(receivable) * rate).toFixed(toFixedDigit);
